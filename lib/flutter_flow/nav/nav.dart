...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: AccessDeniedWidget.routePath,
          builder: (context, params) => AccessDeniedWidget(),
        ),
        FFRoute(
          name: PrivacyAndSettingsWidget.routeName,
          path: PrivacyAndSettingsWidget.routePath,
          builder: (context, params) => PrivacyAndSettingsWidget(),
        ),
        FFRoute(
          name: RepositoryAuditWidget.routeName,
          path: RepositoryAuditWidget.routePath,
